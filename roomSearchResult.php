<?php
    ...
    $sql = "select * from room where Room_Number = '$RoomNum'";
...
<body id="page-top">
    ...
    <div class="card-header">
        ...
        <div class="card-tools">
           <a href ="roomAdd.php"><button class="btn btn-success mb-3 mt-3" href ="roomAdd.php">Create New</button> </a>
        </div>

        <div class="card-tools">
           <a href ="roomSearch.php"><button class="btn btn-success mb-3 mt-3" href ="roomSearch.php">Search Room</button> </a>
        </div>
    </div>
    <div class="card-body">
        <div class="container-fluid">
