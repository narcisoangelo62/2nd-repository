<?php
    ...
    $sql = "select o.ID, o.Student_ID, CONCAT(o.First_Name,' ', o.Last_Name) as StudName,Image,o.Date_Added,o.Semester, o.Room_Number ,o.Status1, o.Age, o.Address, o.Phone, o.Course,v.Number_Violations, o.Year_Level from occupants o left join violators v on o.Student_ID = v.Student_ID ";
...
<body id="page-top">
    ...
    <div class="card-header">
        <h3 class="card-title"><b>List of Occupants</b></h3>
        <div class="btn-group">
        <div class="card-tools">
           <a href ="occupantsAdd.php"><button class="btn btn-primary mb-1 mt-1" style="margin-left:5px" >Add New Occupants</button> </a>
        </div>
        
           <a href ="paymentStatusCheck.php"><button class="btn btn-primary mb-1 mt-1" style="margin-left:10px">Student Status</button> </a>
        </div>
    </div>
    <div class="card-body">
        <div class="container-fluid">
                ...
                <?php
                                foreach ($results as $result) {
                                    echo '<tr>
                                            ...
                                            <td>'.$result['Number_Violations'].'</td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><strong>Status:</strong> '.$result['Status1'].'</p>
                            <p><strong>Violations:</strong> '.$result['Number_Violations'].'</p>
