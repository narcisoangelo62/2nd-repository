...
<body id="page-top">
 ...
 <?php
                        ...
                        ?>
                        <form action = "occupantsEditSave.php" method="post">
                        ...
                        <fieldset class="border-bottom">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" name="Room_Number" class="form-control form-control-sm rounded-0" value="<?=$row['Room_Number']?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" name="Year_Level" class="form-control form-control-sm rounded-0" value="<?=$row['Year_Level']?>">
                                    </div>
                                </div>
