<?php
    ...
    if (empty($haslog)){
        ...
        exit;
                            ...
                            $id = $_GET['id'];
                            $sql = "select o.ID, o.Student_ID, CONCAT(o.First_Name,' ', o.Last_Name) as StudName,Image,o.Semester,o.Date_Added, o.Room_Number ,o.Status1, o.Age, o.Address, o.Phone, o.Course,v.Number_Violations, o.Year_Level from occupants o left join violators v on o.Student_ID = v.Student_ID  where Room_Number = ".$id;
...
<body id="page-top">
    ...
    <div class="card-header">
        <h3 class="card-title">List of Students <?php ?> </h3>
