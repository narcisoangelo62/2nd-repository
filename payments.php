<?php
    ...
    $sql = "select p.ID, c.Student_ID, CONCAT(c.First_Name,' ', c.Last_Name) as StudName, c.Room_Number,p.Amount_Paid,p.Date_Paid from occupants c right join payments p on c.Student_ID = p.Student_ID ";
