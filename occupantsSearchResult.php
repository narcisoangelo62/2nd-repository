<?php
    ...
    $sql = "select * from occupants where Student_ID = '$student_id' OR First_Name = '$firstname' OR Last_Name = '$lastname' ";
...
<body id="page-top">
    ...
    <div class="card-header">
        ...
        <div class="card-tools">
           <a href ="occupantsSearch.php"><button class="btn btn-success float-right mr-4 mb-2" href ="occupantsSearch.php">Search Occupant</button> </a>
        </div>
    </div>
    <div class="card-body">
        <div class="container-fluid">
